...
Assumptions:
1)Young people between ages 0-20
  Middle Aged People between ages 21-60
  Old people between ages 61-100
2)People in class 1 are rich
  People in classes 2,3 are poor

Execution:
To run the Jupyter Notebook just put the location of the titanic.csv file from your local computer.
